function [res_val,accuracy,x,y,alpha,bias] = Kernel_SVM(Train_D_P,Test_D_P,L_Train,L_Test,C)
%
...
%
    ...
    while (it<maxit)
       ...
       alphas_c = 0;
       N=length(y);
       K = kernel(x,x,'l',100); %calculate the kernel
       for i = 1:N
    ...
    res_val = zeros(1,length(L_Test));
    K_Test = kernel(x,Test_D_P,'l',100);
